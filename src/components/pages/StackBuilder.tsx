...
import { Plus, Code, Database, PenTool as Tool, Layers, Save } from 'lucide-react';
...
export const StackBuilder: React.FC = () => {
  ...
  const techOptions = {
    ...
    frameworks: ['React', 'Next.js', 'Vue.js', 'Angular', 'Svelte', 'Express', 'FastAPI'],
    tools: ['Docker', 'Kubernetes', 'AWS', 'GitHub Actions', 'Webpack', 'Vite'],
    databases: ['PostgreSQL', 'MongoDB', 'Redis', 'MySQL', 'DynamoDB', 'InfluxDB']
  };
