          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...register('title')}
                  className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-cyber-yellow focus:ring-1 focus:ring-cyber-yellow transition-all duration-300 text-sm"
            ...
            <div className="bg-cyber-yellow/10 border border-cyber-yellow/30 rounded-lg p-4">
              <h3 className="font-semibold text-cyber-yellow mb-2 text-sm">💡 DevLog Tips</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                {...register('content')}
                rows={12}
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-cyber-yellow focus:ring-1 focus:ring-cyber-yellow transition-all duration-300 resize-none text-sm"
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <h3 className="font-semibold text-green-400 mb-2 text-sm">🚀 Ready to Publish!</h3>
                ...
                <div className="flex justify-between mt-6 pt-4 border-t border-white/10">
                  ...
                  {currentPage < 3 ? (
                    <motion.button
                      type="button"
                      onClick={nextPage}
                      className="flex items-center space-x-2 bg-gradient-to-r from-cyber-yellow to-cyber-pink px-4 py-2 rounded-lg font-orbitron font-bold text-white transition-all duration-300 text-sm"
                    ...
                    <motion.button
                      type="submit"
                      disabled={isLoading}
                      className="flex items-center space-x-2 bg-gradient-to-r from-cyber-yellow to-cyber-pink px-4 py-2 rounded-lg font-orbitron font-bold text-white transition-all duration-300 disabled:opacity-50 text-sm"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
